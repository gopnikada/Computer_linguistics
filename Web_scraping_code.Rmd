...
```{r}
link1 <- httr::GET(paste0(url,links[76]))
...
#content=\"An interview with Benjamin Leard on how to create a bigger electric vehicle market that&#39;s powered by incentives.\"
